...
function PostTaskForm() {
  ...
  // Task fields
  const [preselectedCategory, setPreselectedCategory] = useState(searchParams.get("category") || "");
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 px-6 py-8 max-w-lg mx-auto w-full">
        ...
        <div className="space-y-6">
          {/* Category — show badge if pre-selected, otherwise show picker */}
          {preselectedCategory ? (
            <div className="flex items-center gap-2">
              {categories.find((c) => c.slug === categorySlug) && (
                <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 border border-blue-200 text-blue-700 text-sm font-medium">
                  <span>{categories.find((c) => c.slug === categorySlug)?.icon}</span>
              ...
              <button
                ...
                onClick={() => {
                  ...
                  window.history.replaceState(null, "", "/post-task");
                }}
